...
The 清供 and cultural use is well documented. We make **no medical claims**. The documented, non-medical facts are botanical identity, the Orchidaceae placement, and the refined-floral cultural role.

## Quality and sourcing notes

Practical points for buyers:

- 兰花 is the *Cymbidium* orchid flower, a delicate refined floral — distinguish it from 白兰花 (champaca) and 玉兰 (yulan magnolia), which share the 兰 character but are magnolias.
- Its scent is subtle and up-close; in incense it is a delicate floral reference, not a heavy burned material.
- The orchid is a 清供 flower and a cultural symbol first, a fragrance ingredient second.
...
See also: [champaca](/ingredients/champaca/), [osmanthus](/ingredients/osmanthus/), and the full [scent guide](/blog/scent-guide/).
