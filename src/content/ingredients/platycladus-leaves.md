...
## The 侧柏叶 / 柏子 distinction (read this)
...
The *Bencao Gangmu* (本草纲目), tree section (木之一), records the tree under 柏, explaining "入药惟取叶扁而侧生者，故曰侧柏" — only the flat, side-growing leaves are taken, hence 侧柏 — while the seed (柏实/柏子仁) is treated as its own materia-medica part. **This page describes 侧柏叶 = the leafy branchlets, not the seed.**

## Botanical source and origin

*Platycladus orientalis*, the oriental arborvitae, is a cypress-family evergreen native to China and Korea, widely planted for ornament, timber, and its aromatic parts. The species bears both a leafy branchlet (侧柏叶) and a seed (柏子/柏子仁), used for different purposes. Flora of China records the species; the same botanical identity underlies both the leaf and seed entries here.

## In Chinese tradition

- **Materia medica:** 侧柏叶 appears in traditional Chinese medicine. This is **traditional materia-medica language, not modern clinical evidence.**
- **The tree of 柏子香:** the same *Platycladus orientalis* supplies the seed for the classical scholar's incense 柏子香, recorded separately.
- **Naming:** the *Bencao Gangmu* (本草纲目) explains the name 侧柏 from the flat, sideways-growing leaves.

## Traditional use vs modern evidence

The materia-medica record is **traditional**, not established clinical fact, and we make **no medical claims**. The documented, non-medical facts are botanical identity, the Cupressaceae placement, and the leaf's distinction from the seed.

## Quality and sourcing notes

Practical points for buyers:

- 侧柏叶 is the leafy branchlet of *Platycladus orientalis* (侧柏); expect a fresh, woody, green, slightly resinous scent.
- Distinguish it from 柏子 (cypress seed) — the same tree's seed, a different part with a roasted, nutty character and its own incense role.
- The leaf is a materia-medica part; the seed is the classical incense material.
