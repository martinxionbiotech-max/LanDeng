...
- **Jasmine tea (茉莉花茶):** traditionally said to be China's oldest scented-flower tea, developed around the Song dynasty (960–1279). The classic method layers fresh jasmine flowers with tea leaves so the leaves absorb the scent (traditionally the flowers are then removed).
...
"Jasmine" spans many *Jasminum* species; the classic Chinese fragrance/tea jasmine is *Jasminum sambac* (a different species from common European jasmine). The scent differs accordingly.
