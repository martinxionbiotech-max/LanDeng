...
Agastache has a minty, herbal, slightly sweet aroma with an anise-like undertone — a fresh, green-herbal note rather than a deep or smoky one. It is a *bright* blender, lifting a formula with a clean minty lift, and it is also valued for scenting fabric and clothing.

## The 藿香 / 广藿香 confusion
...
The classical name 藿香 primarily meant *Agastache rugosa*, but because the two plants were traded together and share the name, they have been conflated for centuries. A label that says only "藿香" is underspecified — 藿香 and 广藿香 are different plants with different scents.
...
The aromatic and cultural roles (incense, scenting, Buddhist naming) are well documented. The medicinal uses are **traditional**, not established clinical fact, and we make **no medical claims**. The documented, non-medical facts are botanical identity and agastache's long use as a fresh, minty incense herb.

## Quality and sourcing notes

Practical points for buyers:

- 藿香 (*Agastache rugosa*) and 广藿香 (*Pogostemon cablin*, patchouli) are different plants; check which a label specifies.
- 藿香 is a fresh, minty-anise herb; patchouli is earthy, woody, and balsamic. The scents are not interchangeable.
- The dried herb should smell clean and minty, without mustiness.
