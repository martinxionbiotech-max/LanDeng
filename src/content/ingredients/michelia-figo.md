...
The garden, cut-flower, and fragrance-reference use is documented. We make **no medical claims**. The documented, non-medical facts are botanical identity, the Magnoliaceae placement, and the sweet fruity aromatic use.

## Quality and sourcing notes

Practical points for buyers:

- 含笑花 is *Michelia figo* (syn. *Magnolia figo*), the banana shrub — distinguish it from 白兰花 (*Michelia alba*, champaca) and 玉兰 (*Magnolia denudata*), different magnolia-family flowers.
- Expect a sweet, fruity, faintly banana scent, smaller and more delicate than champaca's heady white-floral.
- Its role is garden and cut-flower fragrance and a classical flower-to-incense reference, not a burned material.
