...
- **松香 (pine resin)** — the hardened oleoresin of the same tree, refined as rosin/colophony. Its own entry.

The *Bencao Gangmu* (本草纲目), tree section (木之一), records the pine under 松, distinguishing its parts: "松葉、松實，服餌所須；松節、松心，耐久不朽。松脂則又樹之津液精華也" — the needles and seeds are taken for consumption, the nodes and heartwood endure, while the resin (松脂) is the tree's vital essence. **This page describes 松针 = the needles, not the resin.**
...
The materia-medica and sachet records are **traditional**, not established clinical fact, and we make **no medical claims**. The documented, non-medical facts are botanical identity, the Pinaceae placement, and the needle's distinction from the resin.

## Quality and sourcing notes

Practical points for buyers:

- 松针 is the needle of *Pinus* species; expect a bright, piney, conifer-fresh, green scent.
- Distinguish it from 松香 (pine resin) — the same tree's resin, a warmer, balsamic, resinous material with its own incense role.
- The needle is a fresh, green top note; the resin is a warmer base — related but used differently in blends.
...
See also: [pine-resin (松香)](/ingredients/pine-resin/), [cedar](/ingredients/cedar/), [juniper](/ingredients/juniper/), and the full [scent guide](/blog/scent-guide/).
