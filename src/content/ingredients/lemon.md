...
- 柠檬 (lemon) here is *Citrus × limon*; expect a bright, zesty, sweet-sour rind scent from cold-pressed peel oil.
- Distinguish it from 香橼 (citron), 佛手 (finger citron), and 柚皮 (pomelo peel) — different citrus materials with different Chinese identities.
- Lemon is a top note; it fades quickly, so it is usually blended rather than burned alone.
...
See also: [citron (香橼)](/ingredients/citron/), [finger citron (佛手)](/ingredients/finger-citron/), [pomelo peel (柚皮)](/ingredients/pomelo-peel/), and the full [scent guide](/blog/scent-guide/).
...
**Source:** 柠檬 (*Citrus × limon*) vs 香橼 (*Citrus medica*) vs 佛手 (*C. medica* var. *sarcodactylis*) vs 柚皮 (*Citrus maxima*). **Evidence type:** Practical screening.
