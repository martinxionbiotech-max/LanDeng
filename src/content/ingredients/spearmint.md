...
All three share a minty family character, but they are different species (or a hybrid) with different aromas and chemistry.
...
- 留兰香 (spearmint) here is *Mentha spicata*; expect a sweet, cooling, minty-fresh, green scent.
- Distinguish it from 薄荷 (*Mentha haplocalyx* / *M. canadensis*) and 胡椒薄荷 (*Mentha × piperita*) — different mints with different aromas.
- Spearmint is sweeter and softer than peppermint; specify the species when sourcing.
