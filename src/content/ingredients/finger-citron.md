...
Both are grown for fragrant rind rather than juice, and both are used as 清供 and room-fragrance fruits. **This page describes 佛手 = the fingered citron.** When a source means the plain fruit, it is describing 香橼.
...
- 佛手 is the finger citron (*Citrus medica* var. *sarcodactylis*); expect a sweet, floral, lemony rind scent from the thick, oil-rich skin, not the juice (there is almost none).
- It is a fragrance fruit for display and room scent, not a burned incense material, and is not a 香乘 ingredient.
- Distinguish it from the plain 香橼 (*Citrus medica*) — same species, different fruit form.
...
See also: [citron](/ingredients/citron/), [orange-peel](/ingredients/orange-peel/), and the full [scent guide](/blog/scent-guide/).
...
**Source:** 佛手 (*Citrus medica* var. *sarcodactylis*) vs 香橼 (*Citrus medica*). **Evidence type:** Practical screening.
