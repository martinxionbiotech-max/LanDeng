...
*Paeonia lactiflora* is a herbaceous perennial of the peony family, native to central and eastern Asia (northern China, Mongolia, Siberia, and adjacent regions) and cultivated in China for well over a thousand years, with many double-flowered garden cultivars. The fragrant part is the flower; the root (白芍/赤芍 in materia medica) is separately a traditional medicine. Flora of China records the species.
...
The ornamental and cultural use is well documented. Medicinal uses are **traditional**, not established clinical fact, and we make **no medical claims**. The documented, non-medical facts are botanical identity, the Paeoniaceae placement, and the garden/parting-flower record.

## Quality and sourcing notes

Practical points for buyers:

- 芍药 is the Chinese herbaceous peony (*Paeonia lactiflora*); expect a floral, rosy, sweet, green scent, though some cultivars are nearly scentless.
- It is a garden and cultural flower — its classical name 将离 records a parting custom, not an incense role.
- Distinguish it from the tree peony (*Paeonia × suffruticosa*, 牡丹), a different peony species with overlapping garden use.
