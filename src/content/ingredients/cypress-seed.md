...
*Platycladus orientalis*, the oriental arborvitae, is a cypress-family evergreen native to China and Korea, widely planted for ornament and timber. The part used is the seed (柏子, or 柏子仁 for the shelled kernel). The tree's leafy branchlets (侧柏叶) are a separate materia-medica material; the seed is the incense material of 柏子香.

> **A naming caution:** 柏子 is the oriental arborvitae seed (*Platycladus orientalis*), not the "cypress" of the Mediterranean genus *Cupressus*. English "cypress" covers both, but the Chinese incense material is the oriental arborvitae seed.

## In Chinese tradition

- **柏子香 (cypress-seed incense):** 柏子 is the single humble material of the classical recipe — scald the green, unopened seeds in boiling water, soak in wine, seal with honey for about seven days, then dry in the shade. The *Xiang Cheng* (香乘) records it with no fixed quantity ("however many"), a recipe that is deliberately unmeasured.
- **Scholar's incense:** the poet Su Shi is recorded pairing 柏子香 with a humble meal — "铜炉烧柏子，石鼎煮山药" (a bronze burner of cypress seed, a stone pot of yam) — the tradition's reminder that incense was a practice, not a luxury.
- **Materia medica:** 柏子仁 (the shelled seed) is recorded in traditional Chinese medicine. This is **traditional materia-medica language, not modern clinical evidence.**
...
See also: [pine-resin](/ingredients/pine-resin/), [cedar](/ingredients/cedar/), the [cypress-seed incense recipe](/blog/baizi-incense-recipe/), and the full [scent guide](/blog/scent-guide/).
