...
| Question | Answer |
|---|---|
| Is it a different species? | No — it is the top resin-transformed grade of *Aquilaria* agarwood |
| What makes it different? | "Oil wraps wood" (油包木) — the wood fiber is so resin-saturated it is soft and kneadable |
| Can you tell by touch? | The traditional test: it shaves into curls and kneads into pellets (削之成卷、捏之成丸) |
...
English incense writing uses "kyara" because the Japanese term for 奇楠 — *kyara* (伽羅) — entered Western vocabulary first, largely through the Japanese kōdō (香道) tradition. This is a small but real lesson: the "English" name for a Chinese grade arrived via a Japanese intermediary.

The etymology of 奇楠 itself is genuinely disputed — Sanskrit theories, a possible "tagara" mistranslation, and more — and the honest position is "uncertain." The [grading guide](/blog/agarwood-grading-guide/) lays out the competing theories without picking one.

---

## Where to Go for the Deep Dives

- **沉水 (sinking) grading** and the **five-color 奇楠 hierarchy** (白/绿/紫/黄/黑) → [agarwood grading guide](/blog/agarwood-grading-guide/)
- **How fakes exploit 奇楠's price** → [incense authentication database](/blog/incense-authentication-database/)
- **What to check before buying** → [qinan buying & authentication](/blog/qinan-buying-authentication/)
- **The material itself** → [agarwood incense guide](/blog/agarwood-incense/)

---

## The Author's Take

**Position:** The most useful thing to know about 奇楠 is not its color or its legend — it is that the word means "top grade of agarwood," and most of what is sold as 奇楠 is not.

**Reasoning:**
- The "kyara" naming obscures a simple fact: 奇楠 is agarwood at its most resin-saturated, not a separate treasure.
- Buyers who chase the name without understanding the grade are the ones the fakes target.
...
- 奇楠 as the top agarwood grade and "oil-wraps-wood vs wood-wraps-oil" are drawn from Chinese specialist sources and traditional grading frameworks.
...
- [Qinan Buying & Authentication](/blog/qinan-buying-authentication/)
- [Agarwood Incense Guide](/blog/agarwood-incense/)

**Natural next step:** before you buy, read [qinan buying & authentication](/blog/qinan-buying-authentication/) — most "奇楠" on the market is not.
