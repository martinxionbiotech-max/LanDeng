...
Avoid a bright citrus or a bold resin — those read as energizing, which fights the wind-down you are after. See the [scent guide](/blog/scent-guide/) for the full spectrum.

---

| You want… | Scent | Character |
|---|---|---|
| Warm, soft wind-down | Sandalwood | Creamy, sweet, woody |
| Deep, quiet close | Agarwood | Resinous, sweet, complex |
| Light, floral reset | Lavender | Soft, herbal, floral |
| Fresh, clean end | Cedar | Woody, clean, room-clearing |
...
**Natural next step:** see [study & deep work](/blog/study-deep-work/) for the other end of the day, or pick your [format](/blog/which-incense-format/).
